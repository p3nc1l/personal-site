...
const Button = (props: { children?: ReactNode, size?: "small" | "normal" | "large", fullWidth?: boolean, loading?: boolean }) => {
  const padding = props.size == "small" ? "0.25em" : props.size == "large" ? "1em" : "0.5em";

  return (
    <motion.span 
      className={`cursor-pointer bg-white text-black rounded-sm font-bold text-center inline-flex justify-center items-center`} 
